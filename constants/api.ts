...
export const API_ENDPOINTS = {
  ...
  AUTH: {
    ...
    COMPANY_SIGNUP: "/users/company-signup",
    COMPANY_EMAIL_VERIFICATION: "/users/company-signup/email-verification",
    COMPANY_EMAIL_VERIFICATION_CHECK: "/users/company-signup/email-verification/check",
    LOGOUT: "/auth/logout",
  ...
  JOB_POSTINGS: {
    ...
    GET: (jobId: number | string) => `/job-postings/${jobId}`, // GET - 채용공고 상세 조회
  },
  // 내 지원 현황
  JOB_APPLICATIONS: {
