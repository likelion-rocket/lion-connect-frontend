...
// 섹션 훅
import { useEducationSection } from "@/hooks/talent/register/sections/useEducationSection";
import {
  useCareerSection,
  type CompanyForm,
} from "@/hooks/talent/register/sections/useCareerSection";
import { useLanguageSection } from "@/hooks/talent/register/sections/useLanguageSection";
import { useCertificationSection } from "@/hooks/talent/register/sections/useCertificationSection";
import { useAwardSection } from "@/hooks/talent/register/sections/useAwardSection";

// 쿼리 훅
import { useMyEducations } from "@/hooks/talent/queries/useMyEducation";
...
import { useMyExperiences } from "@/hooks/talent/queries/useMyExperiences";
import { useMyLanguages } from "@/hooks/talent/queries/useMyLanguages";
import { useMyCertifications } from "@/hooks/talent/queries/useMyCertifications";
import { useMyAwards } from "@/hooks/talent/queries/useMyAwards";
import { useMyJobs } from "@/hooks/talent/queries/useMyJobs";

// 업데이트 훅
import { useUpdateExpTags } from "@/hooks/talent/queries/useUpdateExpTags";
import { useUpdateSkills } from "@/hooks/talent/queries/useUpdateSkills";
import { useUpdateTendencies } from "@/hooks/talent/queries/useUpdateTendencies";
import { useUpdateJobs } from "@/hooks/talent/queries/useUpdateJobs";
